...
public class GameManagertr : MonoBehaviour
{
    public static GameManagertr Instance;
    ...
    {
        devamEttinText.SetText("Bölümü geçmek için " + devamettin + " kere devam ettin.");
        ıpucuSayacText.SetText("Ayrıca " + ıpucuSayac + " kez de ip ucu aldın");
    }
